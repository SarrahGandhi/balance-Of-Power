...
function selectChapter(chapter) {
  ...
  document
    .querySelector(`.chapters div:nth-child(${chapter})`)
...
document
  .getElementById("closeBothSolvedPopup")
...
function verifySelection() {
  if (
    ...
    JSON.stringify(selectedStories) ===
      JSON.stringify(correctAnswers[selectedChapter])
  ) {
    ...
    document.getElementById(`tick-${selectedChapter}`).style.display =
      "inline-block";
